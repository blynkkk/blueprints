...
#define BLYNK_TEMPLATE_ID "TMPL4hh40RjZv"
#define BLYNK_TEMPLATE_NAME "Blink an LED with ESP32"
#define BLYNK_AUTH_TOKEN "Uo3Z9dCSjXCsO0DE-JywCiaRpRbizlSx"
char ssid[] = "vveretko"; // Your WiFi network name
char pass[] = "25252525"; // Your WiFi password. Set the password to "" for open networks.
